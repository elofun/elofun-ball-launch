...
import HigherBallDetect from "./HigherBallDetect";
...
export default class GameManager extends cc.Component {
  ...
  AddToListOfEffectedBall(egg: cc.Node) {
    ...
    // egg.getChildByName("HigherBallDetect").active = true;
  ...
  DFS() {
    console.log(this.ballNeedToTouch);
  ...
  //   //   this.ballNeedToTouch.parent.getChildByName("HigherBallDetect").active =
  //   //     false;
  //   // }
  //   if (this.ballNeedToTouch != null) {
  ...
  //   }
  //   let tempBallNeedToTouch: cc.Node = null;
  //   let tempBallY = null;
  //   let ballNeedToTouchY = null;
  //   this.listOfEffectedBall.forEach((element, index) => {
  //     if (tempBallNeedToTouch == null) {
  //       tempBallNeedToTouch = element;
  //     } else {
  ...
  //         tempBallNeedToTouch.parent.convertToWorldSpaceAR(
  //           tempBallNeedToTouch.getPosition()
  //         )
  //       ).y;
  ...
  //     }
  //   });
  //   if (tempBallNeedToTouch == null) return;
  //   tempBallNeedToTouch
  //     .getComponentInChildren(HigherBallDetect)
  //     .HigherBall.forEach((element) => {
  //       if (element.children.length > 0) {
  //         console.log(element);
  //         this.ballNeedToTouch = element;
  //         element.getChildByName("HightLight").active = true;
  //       }
  //     });
  //   if (this.ballNeedToTouch == null) {
  //     console.log(tempBallNeedToTouch);

  //     this.ballNeedToTouch = tempBallNeedToTouch;
  //   }
  ...
  ClearList() {
    ...
    if (this.listOfEffectedBall.length > 0) {
      this.listOfEffectedBall.forEach((element) => {
        ...
        element.getChildByName("HigherBallDetect").active = false;
      });
    }
    this.listToCheckIsCut.forEach((element) => {
      if (element.children.length > 0) {
