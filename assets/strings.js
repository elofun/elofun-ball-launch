module.exports = {
  ...
  COMMON_SCORE: { EN: "Score:", MY: "ရမွတ္", MU: "ရမှတ်" },
  COMMON_SKILL: { EN: "Skill", MY: "Skill", MU: "Skill" },
  COMMON_ATTACK: { EN: "Attack", MY: "Attack", MU: "Attack" },
  COMMON_COOLDOWN: { EN: "Cool down:", MY: "Cool down:", MU: "Cool down:" },
  COMMON_XP: { EN: "XP", MY: "XP", MU: "XP" },
  COMMON_LV: { EN: "LV.", MY: "LV.", MU: "LV." },
  COMMON_LEVEL_UP: { EN: "Level up!!!", MY: "Level တိုး", MU: "Level တိုး" },
  COMMON_EQUIP: { EN: "EQUIP NOW", MY: "သုံးမည္", MU: "သုံးမည်" },
  COMMON_UNEQUIP: { EN: "UNEQUIP", MY: "မသုံးပါ", MU: "မသုံးပါ" },
  COMMON_YES: { EN: "Yes", MY: "Yes", MU: "Yes" },
  COMMON_NO: { EN: "No", MY: "No", MU: "No" },
  COMMON_OK: { EN: "OK", MY: "OK", MU: "OK" },
  COMMON_COPY: { EN: "Copy", MY: "ကူးယူမည္", MU: "ကူးယူမည်" },
  COMMON_TURN_REMAIN: {
  ...
  COMMON_NO_OF: { EN: "No.", MY: "No.", MU: "No." },
  COMMON_DATE_TIME: { EN: "Date / Time", MY: "ရက္/အခ်ိန္", MU: "ရက်/အချိန်" },
  PLAYER_ID: { EN: "Your ID:", MY: "သင့္ ID", MU: "သင့် ID" },
  PLAYER_STAR: {
    EN: "Collected Stars",
    MY: "ရရွိထားေသာၾကယ္မ်ား",
    MU: "ရရှိထားသောကြယ်များ",
  },
  PLAYER_RANK: { EN: "Current Rank:", MY: "လက္ရွိအဆင့္", MU: "လက်ရှိအဆင့်" },
  BOOSTER_TITLE: {
    EN: "Booster pack",
    MY: "အင္အားတိုး Pack",
    MU: "အင်အားတိုး Pack",
  ...
  BOOSTER_HP: { EN: "Max HP", MY: "Max HP", MU: "Max HP" },
  BOOSTER_CONFIRM: {
  ...
  LB_STAR_TITLE: { EN: "TOP STAR", MY: "TOP STAR", MU: "TOP STAR" },
  LB_STAR_DESC: {
  ...
  LB_STAR_TIME: { EN: "Star Times", MY: "Star Times", MU: "Star Times" },
  LB_STARS: { EN: "Stars", MY: "Stars", MU: "Stars" },
  LB_SCORE_TITLE: { EN: "TOP SCORE", MY: "TOP SCORE", MU: "TOP SCORE" },
  LB_SCORE_TIMES: { EN: "Score time", MY: "Score time", MU: "Score time" },
  LB_SCORES: { EN: "Score", MY: "Score", MU: "Score" },
  LB_WINNER_TITLE: {
    EN: "WINNER LIST",
    MY: "ကံထူးရွင္မ်ား",
    MU: "ကံထူးရှင်များ",
  ...
  LB_THIS_WEEK: { EN: "This Week", MY: "ယခုအပါတ္", MU: "ယခုအပါတ်" },
  LB_LAST_WEEK: { EN: "Last Week", MY: "ယခင္အပါတ္", MU: "ယခင်အပါတ်" },
  LB_PERIOD: { EN: "Period:", MY: "အခ်ိန္", MU: "အချိန်" },
  GG_GIFT: { EN: "GIFTS", MY: "ဆုလက္ေဆာင္မ်ား", MU: "ဆုလက်ဆောင်များ" },
  GG_GIFT_SPECIAL: {
    EN: "SPECIAL PRIZES",
    MY: "စပါယ္ရွယ္ဆုမ်ား",
    MU: "စပါယ်ရှယ်ဆုများ",
  },
  GG_GUIDE: { EN: "GUIDE", MY: "လမ္းၫႊန္ခ်က္", MU: "လမ်းညွှန်ချက်" },
  GG_GUIDE_01: {
    EN: "How to play game?",
  ...
  HISTORY_TURN: { EN: "TURN", MY: "ကစားခြင့္", MU: "ကစားခွင့်" },
  HISTORY_TURNS: { EN: "Turn", MY: "ကစားခြင့္", MU: "ကစားခွင့်" },
  HISTORY_PRIZE: { EN: "PRIZE", MY: "ဆုလက္ေဆာင္", MU: "ဆုလက်ဆောင်" },
  HISTORY_GIFT: {
    EN: "Received Gifts",
    MY: "ရရွိသည့္ဆုမ်ား",
    MU: "ရရှိသည့်ဆုများ",
  },
  HISTORY_LUCKY_CODE: { EN: "Lucky Code", MY: "လပ္ကီးကုဒ္", MU: "လပ်ကီးကုဒ်" },
  ...
  END_GAMEOVER: { EN: "Game Over", MY: "Game Over", MU: "Game Over" },
  END_BEST_SCORE: {
    EN: "BEST\nSCORE",
    MY: "အေကာင္း\nဆုံးရမွတ္",
    MU: "အကောင်း\nဆုံးရမှတ်",
  },
  END_REPLAY: { EN: "PLAY AGAIN", MY: "ထပ္‌ကစား", MU: "ထပ်‌ကစား" },
  END_PRIZE: {
  ...
  GAME_MODE_VOICE: { EN: "Use voice", MY: "အသံျဖင့္", MU: "အသံဖြင့်" },
  ...
  GAME_MODE_HAND: { EN: "Use hand", MY: "လက္ျဖင့္", MU: "လက်ဖြင့်" },
  GAME_MODE_HAND_DESC: {
    EN: "SHAKE\n2 JUMP",
    MY: "ခုန္ရန္ဖုန္းကို\nလႈပ္ခါပါ",
    MU: "ခုန်ရန်ဖုန်းကို\nလှုပ်ခါပါ",
  ...
  WARNING_VOICE_2: { EN: "PLEASE CHOOSE", MY: "ေ႐ြးခ်ယ္ပါ", MU: "ရွေးချယ်ပါ" },
  WARNING_VOICE_3: {
    EN: "“SHAKE 2 JUMP MODE”",
    MY: "“SHAKE 2 JUMP MODE”",
    MU: '"SHAKE 2 JUMP MODE"',
  },
  GAME_GO: { EN: "GO!", MY: "GO!", MU: "GO!" },
  GAME_WAVE: { EN: "Wave", MY: "Wave", MU: "Wave" },
  GAME_ENEMY_NOTICE: {
  ...
  "GG_GRAND PRIZE": { EN: "GRAND PRIZE", MY: "ထိပ္တန္းဆု", MU: "ထိပ်တန်းဆု" },
  "GG_PREMIUM PRIZE": {
    EN: "PREMIUM PRIZES",
    MY: "အထူးဆုမ်ား",
    MU: "အထူးဆုများ",
  ...
  UI_CANCEL: { EN: "CANCEL", MY: "ထြက္မည္", MU: "ထွက်မည်" },
  UI_RETRY: { EN: "RETRY", MY: "ျပန္လုပ္မည္", MU: "ပြန်လုပ်မည်" },
  UI_QUIT: { EN: "QUIT", MY: "ထြက္ခြာမည္", MU: "ထွက်ခွာမည်" },
  UI_WRONG: {
